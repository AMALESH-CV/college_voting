...
$q1="select * from grouptutor where email='$tutorid' and status='active'";
// echo $q1;
$res = mysqli_query($con,$q1);
$arry=mysqli_fetch_array($res);
$classname=$arry['class_name'];
...
elseif($i==6)
{
	  ...
	  ".str_replace('_', ' ', $name)."</label><input type='text' name='$name'class='form-control' value='$classname' readonly> </div>
                                        </div>";
...
elseif($i==2)
{
	  ...
	  ".str_replace('_', ' ', $name)."</label><input type='text' name='$name'class='form-control' value='$tutorid' readonly> </div>
                                        </div>";
...
{
	echo "<input type='hidden' name='$name' value='profile.jpg' class='form-control'>";
}
// else if($i==11)
// {
