...
$res=mysqli_query($con,"INSERT INTO $table($fields) VALUES ($datas)");

echo $res;

if($res)
{
	mysqli_query($con, "INSERT INTO `login`(`user_name`, `password`, `type`) VALUES ('$_POST[email]','$_POST[password]','grouptutor')");
