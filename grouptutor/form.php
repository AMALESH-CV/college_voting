...
echo "
	  ...
	  ".str_replace('_', ' ', $name)."</label><input type='text' name='$name'class='form-control' minlength='8'> </div>
                                        </div>";
}
elseif($i==4)
  {
	  ...
	  <div class='col-md-4'>
        ...
        <label>".str_replace('_', ' ', $name)."</label>
	  		 <select name='$name' class='form-control'>
					 <option>MCA$year</option>
					 <option>MBA$year</option>
					 <option>CSE$year</option>
					 <option>CE$year</option>
					 <option>EEE$year</option>
					 <option>ECE$year</option>
					 <option>ME$year</option>
				 </select>
	 			</div>
     </div>";
...
elseif($name=="college_id" )
  ...
  elseif($name=="year" )
  {
	 echo "<div class='col-md-4'>
	  ...
	  ".str_replace('_', ' ', $name)."</label><input type='number' name='$name' min='2021' max='2050' value='2021' class='form-control' > </div>
                                        </div>";
