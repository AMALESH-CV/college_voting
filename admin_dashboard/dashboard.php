...
background:#666;	
                            ...
                            <div class="content all-icons">
                                <div class="row">
								  ...
								  <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                     <a href="../grouptutor/select.php">    
                                       <div class="font-icon-detail"><i class="pe-7s-users"></i>
                                          <input type="text" value=" Group Tutor">
                                       </div>
                                     </a>
                                  </div>
     ...
     <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                     <a href="../student/select.php">    
                                       <div class="font-icon-detail"><i class="pe-7s-note2"></i>
                                          <input type="text" value="Students">
                                       </div>
                                     </a>
                                  </div>
                                   ...
                                   <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                     <a href="../election/select.php">    
                                       <div class="font-icon-detail"><i class="pe-7s-date"></i>
                                          <input type="text" value="Elections">
                                       </div>
                                     </a>
                                  </div>
 ...
 <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                     <a href="../nomination/election_name.php">    
                                       <div class="font-icon-detail"><i class="pe-7s-id"></i>
                                          <input type="text" value="Nomination List">
                                       </div>
                                     </a>
                                  </div>
