 ...
 <th>Del</th> 
  ...
  // $i=0;
   echo "<tbody>";
	...
	$result = mysqli_query($con,"SELECT * FROM $table where p_id='$_SESSION[userid]'");
		...
		for($k=2;$k<5;$k++)
		{
			...
			if($k==4)
			{
		//	  $sql2 = "select *  from customer where id='$row[1]' ";
//    $result2 = mysqli_query($con, $sql2) or die("Error in Selecting " . mysqli_error($connection));
//$row2 =mysqli_fetch_array($result2);
//		
		

			echo "<td > Contact No : $row[contact_number] <br>
			...
			echo "
			<td><a href='../billing/form.php?userid=$row[id]'>Payment</a></td>
			<td><a href='../document_all/select.php?userid=$row[id]'>Documents</a></td>
