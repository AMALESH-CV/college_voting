...
$vid=mysqli_query($con,"INSERT INTO $table($fields) VALUES ($datas)") or die("error".mysqli_error($con));

//mkdir("../validkey4vote/$vid", 777) ;

header("location:form.php?a=1&mid=$_POST[family_id]");
?>
