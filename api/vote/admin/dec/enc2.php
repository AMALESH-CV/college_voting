...
$id=14;
	  ...
	  $result2 = mysqli_query($con,"select *  from registartion  ");
...
echo "<h3> User $id For Future Use Click To Download</h3>";
echo "<a href='key/enc$id.txt' download>enc$id.txt</a><br>";
...
mysqli_query($con,"update registartion set blockkey='$strEncrypted' where id='$id'") or die("error".mysqli_error($con));
...
fclose($myfile);
		...
		echo "<a href='private/private$id.txt' download>private$id.txt</a><br>";
		echo "<br>--------------------------------------------------<br>";
